...
export const getElements = (): NodeListOf<HTMLElement> => {
    return document.querySelectorAll('.add-article div.article > *');
};

export const handleRows = (key: string, tag: string) => {
...
export const addElement = async (value: string, imageFile?: File | null) => {
